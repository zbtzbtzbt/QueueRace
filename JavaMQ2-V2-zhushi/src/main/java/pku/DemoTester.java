                ...
                try {
                    ...
                    for (byte[] msg : msgs) {
                        if (!new String(msg).equals(String.valueOf(index++))) {
                            System.out.println("index check "+msg.length+" "+String.valueOf(index).getBytes().length);
                            System.out.println("Index Check error "+ new String(msg)+" "+String.valueOf(index));
